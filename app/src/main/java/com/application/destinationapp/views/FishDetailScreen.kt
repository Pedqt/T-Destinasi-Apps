...
import com.application.destinationapp.views.utils.CustomUpdateButton
        ...
        Column(modifier = Modifier.padding(20.dp)) {
            ...
            Column(
                ...
                Box {
                    ...
                    DropdownMenu(
                        ...
                        ticketType.forEachIndexed { index, selectedItem ->
            ...
            Column(modifier = Modifier.align(Alignment.CenterHorizontally)) {
                CustomUpdateButton(stringResource(id = R.string.update_fish))
                {
                    ...
                    Toast.makeText(context, "Destination updated successfully", Toast.LENGTH_SHORT)
                        .show()
                ...
                Column(
                    ...
                    if (openDialog.value) {
                        AlertDialog(
                            ...
                            title = {
                                Text(text = "Deleting Destination")
                            },
                            text = {
                                Text(text = "Do you really want to Delete this Destination??")
                            },
                            confirmButton = {
                                Button(
                                    onClick = {
                                        ...
                                        Toast.makeText(context, "Destination Deleted successfully", Toast.LENGTH_SHORT)
                                            .show()
