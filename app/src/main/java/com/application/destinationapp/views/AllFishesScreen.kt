...
import com.application.destinationapp.views.utils.CustomButtonDetail
    ...
    Box(
        ...
        Column(
            ...
            if (fishes.isEmpty()) {
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.padding(start = 80.dp, top = 20.dp, bottom = 35.dp)) {
                    Text(
                        text = stringResource(id = R.string.all_fishes_title),
                        modifier = Modifier,
                        fontSize = 36.sp,
                    ...
                    items(fishes) { fish ->
                        OutlinedCard(
                            ...
                            Column(
                                ...
                                AsyncImage(
                                    model = "https://source.unsplash.com/400x400/?destination",
                                ...
                                CustomButtonDetail(buttonText = "Detail Destination") {
